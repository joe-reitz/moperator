  ...
  if (!schema) {
    return (
      <div className="rounded-lg border border-dashed border-border bg-surface p-6">
        <h3 className="text-base font-medium text-foreground mb-2">AEO / Schema (JSON-LD)</h3>
  ...
  return (
    <div className="rounded-lg border border-border bg-surface overflow-hidden">
      <div className="px-6 pt-5 pb-3">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            <h3 className="text-base font-medium text-foreground">AEO / Schema (JSON-LD)</h3>
            <div className="flex gap-1.5">
              {schemaTypes.map((type) => (
                <span
                  key={type}
                  className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] bg-surface-elevated text-foreground"
                >
                  {type}
                </span>
              ))}
              <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] bg-surface-elevated text-foreground">
      ...
      <div className="px-6 pb-6">
        <pre className="overflow-x-auto rounded-lg bg-background p-4 text-xs font-mono text-foreground max-h-[500px]">
