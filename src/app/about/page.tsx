          ...
          <div className="animate-fade-up" style={{ animationDelay: "300ms" }}>
            ...
            <div className="space-y-6 text-lg md:text-xl leading-relaxed">
              <p className="text-muted">
                Operations professionals are some of the{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  title: "Real Projects",
                  description: "Apps relevant to Ops work you can learn from.",
                },
                {
                  icon: (
                    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="animate-fade-up" style={{ animationDelay: "600ms" }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-8 py-4 rounded-xl border border-border bg-surface hover:bg-surface-elevated hover:border-accent/30 transition-colors text-lg font-medium"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
